...
export const studyCountries: CountryOption[] = [
  ...
  { value: "united-states", en: "United States", ar: "الولايات المتحدة", aliases: "usa us united states america american", cities: cities([["boston","Boston","بوسطن"],["new-york","New York City","نيويورك"],["los-angeles","Los Angeles","لوس أنجلوس"],["chicago","Chicago","شيكاغو"],["san-francisco","San Francisco Bay Area","منطقة خليج سان فرانسيسكو"],["seattle","Seattle","سياتل"],["austin","Austin","أوستن"],["washington-dc","Washington, D.C.","واشنطن العاصمة"],["philadelphia","Philadelphia","فيلادلفيا"],["san-diego","San Diego","سان دييغو"],["other-us-study","Another US study city","مدينة دراسية أمريكية أخرى"]]) },
