...
const labels = {
  en: [["Design your dream journey", "/design-your-journey"], ["Discover Saudi Arabia", "/discover-saudi-arabia"], ["Study Abroad (soon)", "/study-abroad"], ["About us", "/about"], ["Corporate (soon)", "/corporate"]],
  ar: [["صمّم رحلة أحلامك", "/design-your-journey"], ["اكتشف السعودية", "/discover-saudi-arabia"], ["الدراسة في الخارج (قريبًا)", "/study-abroad"], ["من نحن", "/about"], ["الشركات (قريبًا)", "/corporate"]],
} as const;
