...
export function Header() {
  ...
  return <header className={`siteHeader ${pathname === "/" ? "overHero" : "solidHeader"}`}>
    <div className="container headerInner">
      <Link href="/" className="brand" aria-label="Memories home"><span className="brandMark">M</span><span><strong>MEMORIES</strong><small>Journeys made personal</small></span></Link>
