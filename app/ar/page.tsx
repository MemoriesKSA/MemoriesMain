...
import { ArrowRight, Compass, Globe2, Medal, MoonStar } from "lucide-react";
...
const promises = [
  ...
  { icon: MoonStar, title: "نراعي صلاتك وطعامك", text: "مساجد وأوقات صلاة ومطاعم حلال" },
...
export default function ArabicHome() {
  return <main>
    ...
    <section className="statsBand"><div className="container stats"><div><strong>٠١</strong><span>رحلات أحلام حول العالم</span></div><div><strong>٠٢</strong><span>اكتشف السعودية</span></div><div><strong>٠٣</strong><span>خطط بالعربي والإنجليزي</span></div><div><strong>٠٤</strong><span>توصلك خلال ساعات</span></div></div></section>
  </main>;
}
