...
export const destinationsAr: DestinationAr[] = [
  ...
  { slug: "canada", name: "كندا", country: "كندا", region: "north-america", image: "/images/destinations/canada.png", blurb: "بحيرات فيروزية وهواء جبلي ومدن ترحّب بك.", description: "اجمع فانكوفر أو تورونتو مع الروكي أو القطارات البانورامية أو الطبيعة الواسعة بوتيرة مريحة.", bestFor: "الطبيعة والعائلات", duration: "١٠–١٦ يومًا" },
